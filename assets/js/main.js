(function($){
    ...
    // Count Time 
function makeTimer() {
    // Set the end time to November 28, 2023 at 00:00:00
    var endTime = new Date("November 28, 2023 00:00:00 GMT+0000");
    ...
    var now = new Date();
    var nowInSeconds = Date.parse(now) / 1000;

    // Calculate the time left
    var timeLeft = endTimeInSeconds - nowInSeconds;
